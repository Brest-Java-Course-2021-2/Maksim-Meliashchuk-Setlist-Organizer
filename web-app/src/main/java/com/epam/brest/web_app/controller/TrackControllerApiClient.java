...
public class TrackControllerApiClient {
    ...
    public final String gotoEditTrackPage(@PathVariable Integer id, Model model) {
        ...
        try {
            if (getAccessTokenValue(auth2AuthorizedClientService) != null) {
                trackApi.getApiClient().setAccessToken(getAccessTokenValue(auth2AuthorizedClientService));
            } else {
                return "login";
            }
    ...
    public final String findAllTracksWithBandName(Model model) {
        ...
        try {
            if (getAccessTokenValue(auth2AuthorizedClientService) != null) {
                tracksApi.getApiClient().setAccessToken(getAccessTokenValue(auth2AuthorizedClientService));
            } else {
                return "login";
            }
